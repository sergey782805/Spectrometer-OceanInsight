...
* **Расчет параметров квантового потока**: вычисление важнейших характеристик фотосинтетически активной радиации — **PFD** (Photon Flux Density) и **PPFD** (Photosynthetic Photon Flux Density).
