...
* **Расчет параметров квантового потока**: вычисление важнейших характеристик фотосинтетически активной радиации — **PFD** (Photon Flux Density) в диапазоне 350-800 нм и **PPFD** (Photosynthetic Photon Flux Density) в диапазоне 400-700 нм. Точноть и диапазон рассчетов зависит от калибровочных коэффициентов.
